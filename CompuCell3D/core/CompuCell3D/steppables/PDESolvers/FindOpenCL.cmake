#
#  This file taken from opencl-book-samples project 
#  @ http://code.google.com/p/opencl-book-samples/source/browse/trunk/cmake/FindOpenCL.cmake
#
# - Try to find OpenCL
...
ELSE (APPLE)
	...
	ELSE (WIN32)
            ...
            # to the library
            FIND_PATH(OPENCL_INCLUDE_DIRS CL/cl.h PATHS ${_OPENCL_INC_CAND} "/opt/homebrew/cuda/include" "/opt/AMDAPP/include")
            FIND_PATH(_OPENCL_CPP_INCLUDE_DIRS CL/cl.hpp PATHS ${_OPENCL_INC_CAND} "/opt/homebrew/cuda/include" "/opt/AMDAPP/include")
